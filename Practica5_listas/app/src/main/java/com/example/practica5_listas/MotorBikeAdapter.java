...
{
    private Motos[] listaMotos;
    public MotorBikeAdapter(Motos[] listaMotos){
    ...
    public static class MotorViewHolder extends RecyclerView.ViewHolder {
        ...
        public void BindMotorbikes(Motos motos){
            ...
            imageView.setImageResource(context.getResources().getIdentifier(motos.image, "drawable", "com.example.practica5_listas"));
    ...
    public void onBindViewHolder(@NonNull MotorViewHolder holder, int position){
        holder.BindMotorbikes(this.listaMotos[position]);
    }

    @Override
    public int getItemCount(){
        return this.listaMotos.length;
    }
